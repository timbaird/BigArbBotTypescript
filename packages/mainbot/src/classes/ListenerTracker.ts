...
class ListenerTracker {
     ...
     */
  addListener(pairName: string, poolName: string, target: Contract, event: string, listener: (...args: any[]) => void): void {
    
    const listenerName: string = `${pairName}_${poolName}_${event}`.toLowerCase();
